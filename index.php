...
<?PHP 
  ...
  $winnidestinasi = mysqli_query($connection, "select * from destinasi_a d JOIN winnisetiawati a
  ON d.destinasiKODE = a.destinasiKODE");
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container-fluid" style="background-color: #AD9B9A;">
    <!-- navbar -->
                      ...
                      ?>
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1" style = "margin-top : 25px;">
                                ...
                                <a href="<?php echo $linkdestinasi;?>" class="btn btn-secondary" style = "background-color: #E85D75;">Read More</a>
                            </div>
                        </div>
                        <?PHP }}?>
...
<!-- akhir hotel join oleh oleh -->
    ...
    <!-- Carousel wrapper -->
  <div
    id="carouselMultiItemExample" class="carousel slide carousel-dark text-center" data-mdb-ride="carousel">
    <!-- Controls -->
        ...
        <div class="container">
          <div class="row">
            <?php while ($row3 = mysqli_fetch_array($foto)){
              $linkdestinasi = "FO01.php?travel=" .urlencode($row3["fotodestinasiKODE"]);?>
            <div class="col-lg-4">
              
              <div class="card">
                <img
                  src="ADMIN/images/<?php echo $row3["fotodestinasiFILE"];?>"
                  class="card-img-top"
                  alt="Waterfall"
                  
                />
                <div class="card-body" >
                  <h5 class="card-title"><?php echo $row3["fotodestinasiNAMA"];?></h5>
                  <p class="card-text">
                  <?php echo substr($row3["travelKET"],0,100);?>
                  </p>
...
<!-- WINNI JOIN DESTINASI -->
<div class="row">
            <div class="jumbotron jumbotron-fluid ">
                <div class="container">
                    <h1 class="display-4" style = "text-align: center; margin-top :25px; margin-bottom:25px;">Hasil Join tabel winnisetiawati dan destinasi</h1>
            </div>        
  </div>
  <div class="row"> 
<?php 
    if(mysqli_num_rows($winnidestinasi) > 0) {
        while ($row = mysqli_fetch_array($winnidestinasi)){
?>
  ...
  <div class="col-sm-6">
    <div class="card border-primary mb-3" >
      <div class="row g-0">
        <div class="col-md-4">
            <img src="ADMIN/images/<?php echo $row["destinasiFOTO"]?>" class="img-fluid rounded-start" alt="foto destinasi">
        </div>
        <div class="col-md-8">
          <div class="card-body text-primary">
            <h5 class="card-title"><b>Kota Winni : </b> <?php echo $row["winniKOTA"]?></h5>
              <p class="card-text"><b>keterangan destinasi : </b><?php echo $row["destinasiKET"]?></p>
              <p class="card-text"><small class="text-muted"><b>Nama destinasi : </b><?php echo $row["destinasiNAMA"]?></small></p>
          </div>
        </div>
      </div>
    </div>
