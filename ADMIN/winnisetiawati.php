...
if(isset($_POST['simpan'])){
    ...
    $result=mysqli_query($connection, "INSERT INTO winnisetiawati (winniID, winniKOTA, destinasiKODE)
    VALUES ('$winniID', '$winniKOTA', '$destinasiKODE')");
                ...
                <div class="mb-3 row">
                    <label for="kodedestinasi" class="col-sm-2 col-form-label">Kode Destinasi : </label>
                        ...
                        <select name="kodedestinasi" class="form-control" id="kodedestinasi">
                            ...
                            <option>Kategori Destinasi</option>
                            <?php 
