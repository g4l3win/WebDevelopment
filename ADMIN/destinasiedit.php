...
<?php 
	...
	if(isset($_POST['edit']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "png"))
		{
			...
			mysqli_query($connection, "update destinasi set destinasiNAMA ='$namafoto',
            kategoriKODE = '$kodekategori', destinasiKET = '$keterangandestinasi', 
            destinasiFOTO = '$namafile'
	...
	$editdestinasi = mysqli_query($connection, "select * from destinasi where destinasiKODE = '$destinasikode'");
	$rowedit = mysqli_fetch_array($editdestinasi);

	$editkategori = mysqli_query($connection, "select * from destinasi d JOIN kategoriwisata_a k
