                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">KaosKaki untuk kamu dan aku</li>
                        </ol>
<?php 
...
if(isset($_POST['simpan'])){
    ...
    mysqli_query($connection, "insert into kaoskaki values ('$kodekaoskaki', '$namakaoskaki', '$hargakaoskaki', '$keterangankaoskaki')");//kalau kuery harus 1 doang
    header("location:kaoskaki.php");//kalau sudah dientri bisa memanggil lagi ke file destinasi.php
...
<body>
    ...
    <!-- form input -->
            <form method="POST">
                ...
                <div class="mb-3 row">
                    <label for="kodekaoskaki" class="col-sm-2 col-form-label">Kode Kaoskaki</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="kodekaoskaki" id="kodekaoskaki" maxlength="4" placeholder="masukkan kode kaos kaki">
                        </div>
                </div>
                <div class="mb-3 row">
                    <label for="namakaoskaki" class="col-sm-2 col-form-label">Nama Kaoskaki</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="namakaoskaki" id="namakaoskaki" placeholder="masukkan nama kaos kaki">
                        </div>
                </div>
                <div class="mb-3 row">
                    <label for="harga" class="col-sm-2 col-form-label">Harga Kaoskaki (Rp)</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="harga" id="harga" placeholder="masukkan harga kaoskaki">
                        </div>
                </div>
                <div class="mb-3 row">
                    <label for="keterangankaoskaki" class="col-sm-2 col-form-label">Keterangan Kaoskaki</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="keterangankaoskaki" id="keterangankaoskaki" placeholder="masukkan keterangan kaos kaki">
                        </div>
                </div>
            ...
            <?php }?>  <!-- INI PUNYA PHP JADI HARUS DIAPIT PHP     -->
                ...
                <!--------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------->
            <?php 
                $query = mysqli_query($connection, "SELECT * FROM kaoskaki");
