...
if(isset($_POST['simpan'])){
    ...
    mysqli_query($connection, "insert into hotel values ('$hotelKODE', '$hotelNAMA','$alamathotel', '$kategoriKODE')");//kalau kuery harus 1 doang
            ...
            <form method="POST">
                ...
                <div class="mb-3 row">
                    <label for="kodehotel" class="col-sm-2 col-form-label">Kode Hotel : </label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="kodehotel" id="kodehotel" maxlength="4" placeholder="masukkan kode hotel">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="namahotel" class="col-sm-2 col-form-label">Nama Hotel : </label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="namahotel" id="namahotel" placeholder="masukkan nama hotel">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="alamathotel" class="col-sm-2 col-form-label">Alamat hotel : </label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="alamathotel" id="alamathotel" placeholder="masukkan alamat hotel">
                    </div>
                </div>
                <div class="mb-3 row">
