    ...
    <!-- form input -->
            ...
            <?php 
                ...
                if (isset ($_POST["kirim"])){
                    ...
                    from destinasi, kategoriwisata_a where destinasiNAMA LIKE '%".$search."%' AND kategoriwisata_a.kategorikode = destinasi.kategoriKODE");
                }else {
                    //kalau enggak di search jalanin yang else
                    $query = mysqli_query($connection, "select * from destinasi, kategoriwisata_a 
                    where kategoriwisata_a.kategorikode = destinasi.kategoriKODE
