...
if(isset($_POST['ubah'])){
    ...
    mysqli_query($connection, "update detailtravel set travelNAMA = '$namatravel', 
    travelKET = '$keterangantravel' where travelKODE = '$kodetravel'");//kalau kuery harus 1 doang
    header("location:detailtravel.php");//kalau sudah dientri bisa memanggil lagi ke file destinasi.php  
}
$datatravel = mysqli_query($connection, "select * from detailtravel");
$travelKODE = $_GET['ubah'];
$edittravel = mysqli_query($connection, "select * from detailtravel where travelKODE = '$travelKODE'");
            ...
            <form method="POST">
                ...
                <div class="mb-3 row">
                    <label for="kodetravel" class="col-sm-2 col-form-label">Kode Travel</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="kodetravel" id="kodetravel" maxlength="4"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="submit" class="btn btn-secondary" value="Ubah" name="ubah">
