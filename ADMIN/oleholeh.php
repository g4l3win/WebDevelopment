...
if(isset($_POST['simpan'])){
    ...
    $hotelKODE = $_POST["kodedestinasi"];

    //SIMPAN DI TABEL KATEGORI WISATA
    $result=mysqli_query($connection, "INSERT INTO souvenir (souvenirKODE, souvenirNAMA, souvernirJENIS, destinasiKODE)
    VALUES ('$souvenirKODE', '$souvenirNAMA', '$souvenirJENIS', '$hotelKODE')");
    ...
    <form method="POST">
                ...
                <div class="mb-3 row">
                    <label for="kodesouvenir" class="col-sm-2 col-form-label">Kode Oleh-Oleh </label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="kodesouvenir" id="kodesouvenir" maxlength="4" placeholder="input kode oleh oleh">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="namasouvenir" class="col-sm-2 col-form-label">Nama Pusat Oleh-oleh </label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="namasouvenir" id="namasouvenir" placeholder="input nama pusat oleh oleh">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="jenissouvenir" class="col-sm-2 col-form-label">Keterangan Oleh-oleh </label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="jenissouvenir" id="jenissouvenir" placeholder="input keterangan">
                    </div>
                </div>
                <div class="mb-3 row">
